...
@app.callback(
    ...
    dash.dependencies.Input('per_bed', 'value'))
def update_bar_chart(hospital1, hospital2, choice, per_bed):
    fig = mapper.double_bar_chart(df, hospital1, hospital2, choice, per_bed)
    return fig
