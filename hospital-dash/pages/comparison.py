    ...
    html.Div(id='compare_rows', children=[
        ...
        html.Div(id='comp_graph_row', children=[
            ...
            html.Div(id='comp_graph_buttons', children=[
                dcc.RadioItems(id='per_bed', options=['Total Costs', 'Costs Per Bed'], value='Total Costs'),
                html.P(''),
                html.P('When comparing costs, it is important to consider the size of both hospitals. '
                       'In order to have a more fair comparison, select “Cost Per Bed” to view metrics in terms of '
                       'cost per bed.')])
        ]),
    ]),
])
